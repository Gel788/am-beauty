...
export function CatalogHero({
  ...
  return (
    <section className="relative -mt-16 flex min-h-[min(38vh,360px)] items-end overflow-hidden bg-black text-white sm:min-h-[min(44vh,440px)] md:min-h-[min(52vh,520px)]">
